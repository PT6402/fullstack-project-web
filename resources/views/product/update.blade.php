                        ...
                        {{-- <form role="form" action="{{ url('product/update-product' .$pro->id) }}" method="post" enctype="multipart/form-data"> --}}
                            ...
                            <div class="form-group">
                                ...
                                <select name="product_status" class="form-control input-sm m-bot15">
                                    ...
                                    <option value="1" @if($pro->product_status == 1) selected @endif>Hide</option>
                                    <option value="2" @if($pro->product_status == 1) selected @endif>New</option>
                                    <option value="3" @if($pro->product_status == 1) selected @endif>Sale</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Product Description</label>
                                 <textarea class="form-control " rows="5" name="product_description" placeholder="Enter ..."></textarea>
                            </div>
