                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('product/post-update-color')}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                <button type="submit" name="add_product" class="btn btn-info">Complete Creating Product</button>
                                </form>
                            </div>
