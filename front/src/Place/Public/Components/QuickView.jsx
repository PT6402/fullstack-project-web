                ...
                <div className="relative flex w-full items-center bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                  ...
                  <div className="grid w-full grid-cols-1 items-start gap-y-8 gap-x-6 sm:grid-cols-12 lg:items-center lg:gap-x-8">
                    <div className="aspect-w-2 aspect-h-3 overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5">
                      <img src={`http://127.0.0.1:8000/${shoe.images[0].url}`} alt={shoe.name} className="object-cover object-center" />
                    </div>
                    <div className="sm:col-span-8 lg:col-span-7">
                    <p className=" text-green">{shoe.category_name}</p>
                      <h2 className="text-xl font-medium text-gray-900 sm:pr-12">{shoe.product_name}</h2>
                      ...
                      <section aria-labelledby="information-heading" className="mt-1">
                        ...
                        <p className="font-medium text-gray-900">${shoe.product_price}</p>
                      </section>
                      ...
                      <section aria-labelledby="options-heading" className="mt-8">
                        ...
                        <form>
                          ...
                          <button
                            type="submit"
                            className="mt-8 flex w-full items-center justify-center rounded-md border border-transparent bg-dark-blue py-3 px-8 text-base font-medium text-white hover:bg-light-blue focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 bg-black"
                          ...
                          <p className="absolute top-4 left-4 text-center sm:static sm:mt-8">
                            <a href={'/product/' + shoe.id} className="font-medium text-dark-blue hover:text-light-blue">
                              View full details
                            </a>
                          </p>
                        </form>
